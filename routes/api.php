    ...
    Route::post('/mobile/forgot-password/send-otp',   [ForgotPasswordMobileController::class, 'sendOtp']);
    Route::post('/mobile/forgot-password/verify-otp', [ForgotPasswordMobileController::class, 'verifyOtp']);
    Route::post('/mobile/forgot-password/reset',      [ForgotPasswordMobileController::class, 'resetPassword']);
