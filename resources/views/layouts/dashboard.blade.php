        ...
        <div class="sidebar-brand">
            <div class="brand-logo text-center py-2">
                <a href="{{ route('dashboard') }}" class="d-block">
                    <img src="{{ asset('assets/img/logo-noctura.png') }}" 
                        alt="Noctura Logo" 
                        class="brand-logo-full">
                    
                    <img src="{{ asset('assets/img/icon-noctura.png') }}" 
                        alt="Noctura Icon" 
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-group" id="masterDataGroup">
                ...
                <div class="sub-nav">
                    ...
                    <a href="{{ url('/edukasi') }}" class="sub-nav-item" data-sub="edu">
                        <svg class="sub-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('api-tester.index') }}" class="nav-item {{ request()->routeIs('api-tester.*') ? 'active' : '' }}">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
