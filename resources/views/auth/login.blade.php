 ...
 {{-- ── GLOBAL BACKGROUND ── --}}
  ...
  <div class="login-wrapper">
    <div class="login-card form-wrap">
      ...
      <div class="card-left">
        <canvas id="c"></canvas> <img src="{{ asset('assets/img/logo-noctura.png') }}" alt="Noctura Logo" class="card-logo">
      </div>
          ...
          <div class="field-group">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="text" id="email" name="email" value="{{ old('email') }}" placeholder="nama@email.com atau username" class="{{ $errors->has('email') ? 'is-error' : '' }}" autocomplete="new-password">
              </div>
              @error('email')
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="password" id="pw" name="password" placeholder="Masukkan kata sandi" class="{{ $errors->has('password') ? 'is-error' : '' }}" autocomplete="new-password">
