...
<body>
  ...
  <div class="login-wrapper">
    <div class="login-card form-wrap">
      ...
      <div class="card-left">
        <canvas id="c"></canvas> <img src="<?php echo e(asset('assets/img/logo-noctura.png')); ?>" alt="Noctura Logo" class="card-logo">
      </div>
          ...
          <div class="field-group">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="text" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com atau username" class="<?php echo e($errors->has('email') ? 'is-error' : ''); ?>" autocomplete="new-password">
              </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input type="password" id="pw" name="password" placeholder="Masukkan kata sandi" class="<?php echo e($errors->has('password') ? 'is-error' : ''); ?>" autocomplete="new-password">
...
(function(){
  ...
  // Menyesuaikan ukuran canvas dengan div .card-left, bukan layar penuh
  function resize(){ 
  ...
  function init(){
    resize();
    // Mengurangi jumlah bintang menjadi 70 agar tidak terlalu sesak di area kecil
  ...
  function draw(){
    ...
    S.forEach(s => {
      ...
      ctx.fillStyle = `rgba(255, 255, 255, ${s.a})`; /* Dikembalikan ke bintang putih */
      ctx.fill();
    });
...
document.getElementById('rem').addEventListener('change', function(){
  ...
  box.style.background  = this.checked ? 'var(--navy)' : '';
  box.style.borderColor = this.checked ? 'var(--navy)' : '';
});
</script>
</body>
</html><?php /**PATH D:\xampp\htdocs\sleep-detection-backend\resources\views/auth/login.blade.php ENDPATH**/ ?>